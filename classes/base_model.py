...
class BaseModel(NNNetwork):
    '''Base model is a common neural network.'''
    ...
    def _get_hyper_params(self):
        h_params = {'num_layers': hp.choice('num_layers',
                 ...
                 'kernel_size0': hp.choice('kernel_size0', [3, 4, 5, 6, 7, 8]),
    ...
    def get_accuracy(self, model, max_acc_level = 3, verbose = True):
        ...
        accs_at_level = NNNetwork._compute_accuracy(self, max_acc_level=max_acc_level,
